	...
	<view class="update-mask flex-center">
		<view class="content botton-radius">
			<view class="content-top">
				...
				<image class="content-top" style="top: 0;" width="100%" height="100%" :src="require('@/uni_modules/rt-uni-update/static/bg_top.png')"></image>
			</view>
			...
			<image v-if="cancleBtn" class="close-img" :src="require('@/uni_modules/rt-uni-update/static/app_update_close.png')" @click.stop="cancel"></image>
		</view>
	</view>
</template>
...
export default { 
	...
	created() {
		//#ifdef APP-PLUS
		plus.runtime.getProperty(plus.runtime.appid, (inf) => {this.version = inf.version})
		//#endif
		this.cancleBtn = true;
		
		let opts = {
			url: 'system/update/getUniUpdate',
			method: 'get',
			type :5
		};
	...
	methods: {
		...
		confirm() {
			if(this.version ==  this.data.edition_name){
